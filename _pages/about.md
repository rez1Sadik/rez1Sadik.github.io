...
<div style="height: 200px; overflow-y: auto; padding-right: 15px; border-bottom: 1px solid #ddd;">
  <table style="width: 100%; border: none; text-align: left; margin-bottom: 0;">
    <tr style="border-bottom: none;">
      <td style="width: 25%; border: none; padding: 8px 0;">January, 2025</td>
      <td style="border: none; padding: 8px 0;">One paper accepted at ICTCS, 2025.</td>
    </tr>
    <tr style="border-bottom: none;">
      <td style="width: 25%; border: none; padding: 8px 0;">2024</td>
      <td style="border: none; padding: 8px 0;">Multiple papers accepted at SASI-ITE, ICDSIS, and ICSSES.</td>
    </tr>
    <tr style="border-bottom: none;">
      <td style="width: 25%; border: none; padding: 8px 0;">August, 2023</td>
      <td style="border: none; padding: 8px 0;">Started a new position as Data Manager at the Department of Education, State of South Dakota.</td>
    </tr>
    <tr style="border-bottom: none;">
      <td style="width: 25%; border: none; padding: 8px 0;">May, 2023</td>
      <td style="border: none; padding: 8px 0;">Joined Center for Teaching & Learning, USD as a Data Analyst.</td>
    </tr>
    <tr style="border-bottom: none;">
      <td style="width: 25%; border: none; padding: 8px 0;">January, 2023</td>
      <td style="border: none; padding: 8px 0;">Began serving as an Adjunct Lecturer at Beacom School of Business, USD.</td>
    </tr>
  </table>
</div>